...
#if SIZEOF_LONG == 4
#define COPY_LONG(x, y) COPY4(x,y)
#define LOAD_LONG(x, y) LOAD4(x,y)
#define STORE_LONG(x, y) STORE4(x,y)
#else
#if SIZEOF_LONG == 8
...
#else
!ints of size other than 4 or 8 not implemented
#endif
#endif
...
#  else
      char *int_string_copy PROT((const char *));
