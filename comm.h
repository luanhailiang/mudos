...
#ifndef EP_MAX_EVENT
#define EP_MAX_EVENT		256			/* Default epoll max event */
#endif

#ifndef	EP_TIME_OUT
#define EP_TIME_OUT			10			/* Default epoll time out */
#endif

#ifndef EP_MAX_CTL
#define EP_MAX_CTL 			4096		/* Default epoll max check amount */
#endif

#ifndef EP_TICK_FLUSH
#define EP_TICK_FLUSH				10			/* Default flush message tick */
#endif

#define EXTERNAL_PORT 		0x01000000
#define ADDR_SERVER_FD 		0x02000000
#define USERS_FD			0x04000000
#define PACKAGE_SOCKETS_FD	0x08000000
#define SPLIT_MARK			0x00ffffff
...
#ifdef EPOLL
INLINE void init_epoll PROT((void));
INLINE void flush_user_message PROT((void));
INLINE void flush_lpc_socket PROT((void));
INLINE void process_io PROT((struct epoll_event *));
INLINE int epoll_ctl_del PROT((int fd));
